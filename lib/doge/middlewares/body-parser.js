...
module.exports = new Class('BodyParser', Middleware, function() {
	this.$.call = function(req, res, next) {
		...
		if (req.contentType == 'application/json') {
			return readBody()
			.then(function() {
				req.requestParameters = JSON.parse(req.body.toString(req.charset));
			})
			.catch(function() {})
			.then(function() {
				return next();
			...
			return readBody()
			.then(function() {
				req.requestParameters = dogeon.parse(req.body.toString(req.charset));
			})
			.catch(function() {})
			.then(function() {
				return next();
			...
			return readBody()
			.then(function() {
				req.requestParameters = qs.parse(req.body.toString(req.charset));
			})
			.catch(function() {})
			.then(function() {
				return next();
